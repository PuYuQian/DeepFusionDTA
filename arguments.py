...
def argparser():
  ...
  parser.add_argument(
      '--lstm_smiles_hidden_dim',
      type=int,
      nargs='+',
      help='Space seperated list of the number of smiles motif filters corresponding to length list. (ex, --llstm_smiles_hidden_dim 100 200 100)'
  )
  parser.add_argument(
      '--lstm_target_hidden_dim',
      type=int,
      nargs='+',
      help='Space seperated list of the number of target motif filters corresponding to length list. (ex, --lstm_target_hidden_dim 100 200 100)'
  )
  parser.add_argument(
      '--num_hidden',
      type=int,
